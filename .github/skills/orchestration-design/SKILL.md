...
この資産の共通本文は [orchestration-design の共通本文](../../../.ai/skills/orchestration-design/SKILL.md) にあります。必ず読み、その指示に従ってください。

## Copilot 固有

- Skill は `.github/skills/` から起動する。Prompt、Agent、Instructions の起動方式を混同しない。
