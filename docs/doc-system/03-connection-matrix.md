...
| 要素型 ↓ \ 依存先 → | VAL | SR | FR | SPEC | TERM | ACTOR | P | I | D | E | MOD | DS | SCM | TD | TC | 備考 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| **VAL** | — | — | — | — | — | — | — | — | — | — | — | — | — | — | — | 根 |
| **SR** | ✅ | — | — | — | — | — | — | — | — | — | — | — | — | — | — | |
| **FR** | — | ✅ | — | — | — | — | — | — | — | — | — | — | — | — | — | |
...
| **NFR** | FND / TC / VERIFY | warning | 検証証跡を受ける |
...
NFR は `refines` 上流にはならない（他要素が NFR を refines しない）。

| 方向 | 意味 |
|---|---|
| NFR → 設計/実装要素 | この NFR が何を制約するか（任意・旧 constrains） |
| FND/TC/VERIFY → NFR | この NFR が検証された証跡（§3 の被依存辺・OR） |
