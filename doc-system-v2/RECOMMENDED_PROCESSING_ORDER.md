...
- Q-2 は「傘 SPEC マップを維持し、実害が出た時点で細分化する」方針を DD 化して close する。
...
9. **#157 Q-2 を傘 SPEC マップ維持方針で DD 化して close**
   - 理由: open Q 1 件をユーザー判断 1 で閉じ、#127 完了判定前の判断待ちを減らす。
   - 反映方針: 傘 SPEC マップ維持を DD として在グラフ化し、実害が出た時点で細分化する後続判断を明記する。

10. **#158 / #159 / #165 / #164 FND 解消群**
    - #158: 本文 resolved 済み open FND を lifecycle 上も resolved へ整理する。
