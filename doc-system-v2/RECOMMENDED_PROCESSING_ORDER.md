...
2. **SRC と TD/TC の実装設計・検証規則化**（完了: 2026-07-09 / PR #147）
   ...
   - 反映: `06-implementation/src` layout、`source.*` / `test.*` サイドカー属性、TD-TC exact link count、SRC/TC 実体参照検査、対応 FORMAT/config/schema/validator/dsv2 検証規則を PR #147 で反映。
