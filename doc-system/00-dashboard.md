...
>
> **最終更新**: 2026-06-14（DD-8 確定・FND-36 resolved（バッジ定義＝ノード固有バージョン・notation.md 更新）・decisions.md v0.1.8・findings.md v0.1.16｜旧: FND-34〜37 起票・FND-34 resolved（VERIFY-5 SR-7→SR-2 訂正）・FND-35/37 は sprint-2）｜ **current_stage**: `requirements`（`docs/doc-system/config.yaml`）
...
| PR #22 レビュー処置（FND-34〜37 起票・FND-34/36 resolved）| FND | ✅ 完了（FND-36 resolved・DD-8 confirmed）・FND-35/37 sprint-2 |
...
### FND サマリ（計 37 件：✅ resolved 35 ／ ⏳ open 2）
...
> FND-1〜34・FND-36 は resolved。open 2 件＝FND-35（sprint-2）・FND-37（sprint-2）。明細は `02-findings.md`。
...
| DD-8 | ✅ 反映済 | ノードバッジ＝ノード固有バージョン（MAJOR.MINOR）正式化・ファイルフロントマター廃止（sprint-2 移行）・notation.md 更新（FND-36 resolved） |
