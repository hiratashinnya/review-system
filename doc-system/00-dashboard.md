...
>
> **最終更新**: 2026-06-13（FND-18 resolved＝重複不可方針で再処置・SPEC-52/53・SPEC-14-1 著作＋RULE-028 追加｜DD-5/6 decided・SPEC-44〜51 著作）｜ **current_stage**: `requirements`（`docs/doc-system/config.yaml`）
...
> **FND サマリ**：計 18 件（✅ resolved 17 ／ ⏳ open 1 ＝ FND-6）。FND-18（I/O フォーマット SPEC）は重複不可方針で再処置・2026-06-13 resolved（I-7 は既存 SPEC-26/36 で充足のため新規ゼロ・I-1 は SPEC-52/53＋RULE-028・O-2 は SPEC-14-1）。
