...
flowchart LR
  ...
  B["L1 境界 D-20・D-21・D-10・D-13"]:::l1ext
...
flowchart LR
  ...
  LA2["ACTOR-2 へ O-1・O-2・O-6"]:::l1ext
...
| D-9 | フェーズ・ステージ状態（current_phase/current_stage/phases/stages） | P-5（P-5-3） | P-1-4・P-2-5 | フロー（L1 配布: P-1/P-2） |
...
| O-6 | 終了コード（0/1・CI ゲート信号・SPEC-25-2/25-3） | P-4 | P-4-4 | ACTOR-2 |
...
| P-3 | カバレッジ点検（P-3-1/3-2 に委譲） | D-20/21・D-10/13 | D-7 |
| P-4 | レポート生成（P-4-1〜4 に委譲） | D-5, D-6, D-7 | O-1, O-2, O-6 |
