...
## FND-106: 03-spec.md 本文「例」記述 12 箇所に旧形式残存（バッジ 2 パート・ref_version 3 パート）

<details><summary>⬡ FND-106 · v0.1.1</summary>
...
- 処置対象 SPEC 12 ノードに `→FND-106` バックリファレンス辺を付与・バッジ z バンプ（v0.1.0→v0.1.1）
