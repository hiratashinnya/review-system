...
<details><summary>⬡ FND-94 · v0.1.1</summary>
...
**指摘時 ref_version**（DD-3・本 FND の根拠はいずれも provenance のため backref を張らず本文記録のみ）:
...
- `resolved: true`・`edges: []`。本 FND の根拠（DD-16 / DD-21 / SPEC-60-2 / FND-101）はいずれも **provenance** であり、backref は張らず上記「指摘時 ref_version」に本文記録のみとする。
