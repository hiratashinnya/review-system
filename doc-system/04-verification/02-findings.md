...
<details><summary>⬡ FND-103 · v0.2.0</summary>
...
<details><summary>⬡ FND-104 · v0.2.0</summary>
...
<details><summary>⬡ FND-105 · v0.2.0</summary>
...
<details><summary>⬡ FND-107 · v0.1.1</summary>
...
**対応状況**: resolved（2026-06-23・案 A 実施済み）

> **辺の扱い（resolved 段階）**: 本 FND は open 段階では `edges: []`（対象辺未確定）で起票しており、open 段階で付与した forward 辺は存在しない。案 A 承認・実施に伴い、指摘対象（FR-1・DD-8・DM-1）および z-bump 処置を施した SPEC-47 への forward 辺を**今回初めて付与**した。open 段階に forward 辺がなかったため辺逆転操作（FND→対象 を削除して 対象→FND に張替え）は不要（DD-16）。処置対象側のバックリファレンス辺は SPEC-47 に `→FND-107` を付与済み（コミット `7f55788`）。
