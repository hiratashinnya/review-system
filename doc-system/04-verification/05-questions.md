...
<details><summary>⬡ Q-3 · v0.2.0</summary>
...
## Q-5: resolved-FND 辺逆転の版バンプ（MINOR か z か）／backref・provenance 辺を RULE-004 ドリフト対象外とすべきか
...
<details><summary>⬡ Q-5 · v0.2.0</summary>
...
## Q-6: doc-system 設計層モデリングを skill 資産へどう広げるか — ①pipeline skill のオーケストレーターエージェント化 / ②skill の PROMPT 設計ノード化（両者は結合）

**status: closed**（DD-22 へ昇格）

<details><summary>⬡ Q-6 · v0.2.0</summary>
