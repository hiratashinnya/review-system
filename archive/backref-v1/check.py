...
依存仕様: DD-16 v0.1.0（FND ライフサイクル＝must_link_to/must_be_linked_from/must_not_link_to）・
  DD-3 v0.1.0（指摘時 ref_version 本文記録）。補助（out-of-graph・版なし）: config.yaml fnd_lifecycle。
"""
