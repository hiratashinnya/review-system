...
condition: normal
result: PASS
log_ref: tests/logs/TD-issue-start-452-f17-abe7528.txt
---
...
- TD version: 1
- 実装commit: abe7528011c32b2421355b214e71ac01aa3d21dd
- prompt雛形版 / 基準content_hash: N/A（host transactionのmodel-free unit）
- 実行日: 2026-09-15 Asia/Tokyo
- bridge focused: 16 tests、failure 0、error 0、skip 0
- active outer diagnosis mount: 1 test、failure 0、error 0、skip 0
- supervisor regression: 96 tests、failure 0、error 0、skip 0
- full unit: 1805 tests、failure 0、error 0、skip 9
- coverage: TOTAL 85%、issue_start/codex_karte_bridge.py 88%、`htmlcov/index.html`生成済み（未commit）
- asset parity: 39 assets checked、0 MISSING
- 既存の `TD-issue-start-452-f17-fa62766` FAIL TR は、失敗を隠蔽せず履歴として保持する。
